...
from main.models import Lesson, Courses, Subscription
...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course = Courses.objects.create(name_courses='TestCourse', description_courses='TestCourseDescription')
...
class SubscriptionTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create(email='admin', password='admin', is_superuser=True)
        self.token = f'Bearer {AccessToken.for_user(self.user)}'
        self.course = Courses.objects.create(name_courses="TEST", description_courses="TEST", owner=self.user)
